/*
 * @(#)GameController.java 1.0 31.12.2016
 */
...
import ru.solpro.game.client.local.model.Game;
...
//        });
    ...
    private AnchorPane initLayout() {
        ...
        loader.setLocation(getClass().getResource("../view/GameOfflineLayout.fxml"));
        try {
        ...
        GameOfflineLayoutController gameOfflineLayoutController = loader.getController();
        gameOfflineLayoutController.setGameOfflineController(this);
        return result;
    }
}
